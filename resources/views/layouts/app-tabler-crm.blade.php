...
<div class="dropdown">
    ...
    <ul class="dropdown-menu">
        <li>
            <a class="dropdown-item" href="#" onclick="ManagerTour.restartTour()">
                <i class="fas fa-redo me-2"></i>Повторить обучение
            </a>
        </li>
        <li>
            <a class="dropdown-item" href="#" onclick="document.getElementById('tour-help-button').click()">
                <i class="fas fa-play-circle me-2"></i>Запустить тур
            </a>
        </li>
        <li><hr class="dropdown-divider"></li>
        <li>
            <a class="dropdown-item" href="#" onclick="localStorage.removeItem('managerTourCompleted'); alert('Настройки тура сброшены!');">
                <i class="fas fa-cog me-2"></i>Сбросить настройки тура
            </a>
        </li>
    </ul>
</div>
@endif
    ...
    <script>
    // Передаем роль пользователя из Laravel в JS
